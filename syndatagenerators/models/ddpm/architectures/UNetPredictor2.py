...
from syndatagenerators.models.ddpm.architectures.TaskEmbedding import TaskEmbedding
...
class UNet(nn.Module):
    def __init__(self,n_steps,c_in=3, c_out=3, time_dim=256, remove_deep_conv=True,):
        super().__init__()
...
class UNet_conditional(UNet):
    def __init__(self,n_steps,device, c_in=3, c_out=3, time_dim=256, num_classes=None,num_cont=None, **kwargs):
